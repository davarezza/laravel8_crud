              ...
              <div class="card-body">
                <form method="post" action="/updatedata/{{ $data->id }}" enctype="multipart/form-data">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="number" name="notelepon" class="form-control" id="number" value="{{ $data->notelepon }}">
                  </div>
                  <div class="mb-3">
                    <label for="gambar" class="form-label">Foto</label>
                    <input type="file" name="foto" class="form-control" id="gambar" value="{{ $data->foto }}">
                  </div>
                  <div class="mb-3">
                    <label for="gambar" class="form-label"></label>
                    <img src="{{ asset('fotosiswa/' . $data->foto) }}" alt="Foto Sekarang" width="100">
                </div>
